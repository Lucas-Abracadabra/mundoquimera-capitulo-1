...
const desktopReleaseBase = "https://github.com/Lucas-Abracadabra/mundoquimera-capitulo-1/releases/download/v1.0.6";
const desktopDownloads = [
  { key: "windows", label: "Windows", detail: "Instalador .exe", href: `${desktopReleaseBase}/Mundo-Quimera-Capitulo-1-setup-1.0.6-x64.exe` },
  { key: "macos", label: "macOS", detail: "Arquivo .dmg", href: `${desktopReleaseBase}/Mundo-Quimera-Capitulo-1-1.0.6-mac-arm64.dmg` },
  { key: "linux", label: "Linux", detail: "AppImage", href: `${desktopReleaseBase}/Mundo-Quimera-Capitulo-1-1.0.6-linux-x86_64.AppImage` },
];

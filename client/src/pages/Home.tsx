  ...
  return (
    <main className="quimera-shell">
      ...
      <section className="game-frame">
        ...
        {tab === "mapa" && <section className="tool-panel map-view"><div className="dossier-tag">MAPA NUMERADO · QUIMERA</div><div className="map-image-wrap numbered-map"><img src={mapImage} alt="Mapa numerado de Quimera" /></div><div className="tool-copy"><p className="scene-kicker">ATLAS DE EXPLORAÇÃO</p><h2>{currentLocation}</h2><p>Ender está neste ponto da rota. O mapa mostra a geografia do mundo; a passagem narrativa continua conduzindo cada movimento.</p><div className="map-record"><strong>PASSAGEM ATUAL</strong><span>{String(passage.pid).padStart(3, "0")}</span><strong>VISITADAS</strong><span>{visited.length}</span></div></div></section>}
